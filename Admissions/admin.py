...
from .models import HscScienceSubjects, HscCommerceSubjects, HscArtsSubjects, HscAdmissionScience, HscAdmissionArts, HscAdmissionCommerce, HscSession, ParentInfo, Address, AcademicInformation, Payment, SscSession
